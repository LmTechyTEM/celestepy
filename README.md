# Celeste Py
So Celeste aka UG2 is in development, but uhhhh there's no bots,
SO GUESS WHAT THAT MEANS OPEN BOT MARKET YAYYYYY
But problem there's no API wrappers for it, so I make!
...
Once you've done that you can either run `login.py` to get your token or make a request like sending a message and grabbing your Authorizationheader.
